    ...
    remove(value:number) {
      ...
      while (currentNode) {
        if (value < currentNode.value) {
          ...
          parentNode = currentNode;
          currentNode = currentNode.right;
        } else if (currentNode.value === value) {//We have a match, get to work!
          ...
          if (currentNode.right === null) {
            ...
            } else {//if parent > current, make right child of the left the parent
              if (currentNode.value < parentNode.value) {
          ...
          } else {//find the Right child's left most child
