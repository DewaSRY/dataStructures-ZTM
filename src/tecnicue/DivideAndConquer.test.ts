...
import { search, BinarySearch } from "./DivideAndConquer";
describe.skip("BinarySearch function compare ", () => {
  let suit = BinarySearch;
  const testOne = {
  ...
  ])("test $Arr and  should return $output", ({ Arr, valNum, output }) => {
